        ...
        <div className="container">
            <div className="row justify-content-center min-vh-100">
                <div className="col-md-6 col-11 p-md-0 pe-md-5 p-3 my-md-auto mt-4 text-white">
                    ...
                    <button className="btn btn-sm px-4 rounded-5 bg-white text-secondary fw-medium shadow" onClick={turnCalc}>{turned ? "Flip Back" : "View Info"}</button>
                </div>
