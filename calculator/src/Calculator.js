        ...
        <div className="container">
            <div className="row justify-content-center min-vh-100">
                <div className="col-md-6 col-11 p-md-0 pe-md-5 p-3 my-md-auto mt-4 text-white">
                    ...
                    <button className="btn btn-sm px-4 rounded-5 bg-white text-secondary fw-medium shadow" onClick={turnCalc}>View details</button>
                </div>
                    ...
                    <div className="backside position-absolute rounded-4">
                        <div className="cover mx-auto p-3 stroked-text d-flex flex-column justify-content-center">
                            ...
                            <div className="d-flex align-items-center mb-3 gap-3">
                                ...
                                <svg fill="#d4d4d4" version="1.1" width="33px" height="33px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" stroke="#d4d4d4">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
